...
class LeaveApplicationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $remainingCredits = $employee ? $employee->getRemainingLeaveCredits() : [];
    ...
    private function calculateWorkDays($startDate, $endDate)
    {
        ...
        $holidays = [
            '2025-12-30', '2025-12-31', '2026-01-01', '2026-01-02', '2026-02-25',
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'classes_data.*.course_code' => 'nullable|string|max:255',
            'classes_data.*.title' => 'nullable|string|max:255',
            'classes_data.*.day_time_room' => 'nullable|string|max:255',
            'classes_data.*.topics' => 'nullable|string|max:1000',
            'classes_data.*.substitute_teacher_id' => 'nullable|exists:employees,id',
            'classes_data.*.acknowledgement_signature' => 'nullable|string|max:255',
        ];
        ...
        if($employee->role === 'staff') {
            ...
            $validatedData['ah_status'] = 'pending';
        }
    ...
    public function leaveSummary(Request $request)
    {
        ...
        // Fetch applications where approval_status is 'approved'
    ...
    public function update(Request $request, LeaveApplication $leaveApplication)
    {
        $rules = [
            ...
            'acknowledgement_personnel_take_over_signature' => 'nullable|string|max:255',
            'classes_data' => 'nullable|array',
            'classes_data.*.id' => 'nullable|exists:leave_application_classes,id',
            'classes_data.*.course_code' => 'nullable|string|max:255',
            'classes_data.*.title' => 'nullable|string|max:255',
            'classes_data.*.day_time_room' => 'nullable|string|max:255',
            'classes_data.*.topics' => 'nullable|string|max:1000',
