...
Route::middleware([
    ...
    Route::middleware(['role:academic_head|registrar|hr|admin'])->group(function () {
       ...
       Route::get('/students/export', [StudentController::class, 'export'])->name('students.export');
        Route::get('/students/education/export', [StudentController::class, 'exportEducation'])->name('students.education.export');
       Route::get('/students/profile-bank', [StudentController::class, 'profileBank'])->name('students.profile.bank');
    Route::get('/students/{student}/education/edit', [StudentController::class, 'editEducation'])->name('students.education.edit');
    Route::put('/students/{student}/education', [StudentController::class, 'updateEducation'])->name('students.education.update');
        Route::resource('students', StudentController::class);

        // --- DOCUMENT CRUD ROUTES ---
        Route::post('/students/{student}/documents', [StudentController::class, 'storeDocument'])->name('students.documents.store');
        Route::delete('/documents/{document}', [StudentController::class, 'destroyDocument'])->name('students.documents.destroy');
        // ------------------------------------
