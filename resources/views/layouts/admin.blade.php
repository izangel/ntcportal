        ...
        <aside class="w-64 bg-gray-900 text-white shadow-lg flex-shrink-0" style="min-height: calc(100vh);">
            ...
            <nav class="p-4 space-y-2">
                ...
                <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                    <i class="fas fa-home mr-3 text-lg"></i> {{ __('Dashboard') }}
                </x-nav-link>
                <x-nav-link href="{{ route('announcements.index') }}" :active="request()->routeIs('announcements.index')">
                    <i class="fa-solid fa-bullhorn mr-3 text-lg"></i> {{ __('School Announcements') }}
                </x-nav-link>
                <x-nav-link href="{{ route('important_dates.index') }}" :active="request()->routeIs('important_dates.index')">
                    <i class="fa-solid fa-calendar-days mr-3 text-lg"></i> {{ __('Important Dates') }}
                </x-nav-link>
                <x-nav-link href="{{ route('portal-updates.list') }}" :active="request()->routeIs('portal-updates.list')">
                    <i class="fa-solid fa-circle-info mr-3 text-lg"></i> {{ __('Portal Updates') }}
                </x-nav-link>

                {{-- My Profile --}}
                <div class="mt-4 space-y-1" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center justify-between w-full text-xs font-semibold uppercase text-gray-400 px-3 py-2 hover:bg-gray-700/50 rounded-md transition duration-150 focus:outline-none">
                    ...
                    <div x-show="open" x-collapse.duration.300ms>
                        <x-nav-link href="{{ route('profile.personal-information') }}" :active="request()->routeIs('profile.personal-information')">
                            <i class="fas fa-user-graduate mr-3 text-lg"></i> {{ __('Personal Information') }}
                        </x-nav-link>
                        <x-nav-link href="{{ route('password.edit') }}" :active="request()->routeIs('password.*')">
                            <i class="fas fa-key mr-3 text-lg"></i> {{ __('Change Password') }}
                        </x-nav-link>
                    </div>
                </div>
                ...
                <div class="mt-4 space-y-1" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse.duration.300ms>
                        <x-nav-link href="#"><i class="fas fa-solid fa-book-open mr-3 text-lg"></i> {{ __('Search Library Catalog') }}</x-nav-link>
                        <x-nav-link href="#"><i class="fas fa-book mr-3 text-lg"></i> {{ __('Request Books') }}</x-nav-link>
                    </div>
                </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('student.course-blocks') }}" :active="request()->routeIs('student.course-blocks')">
                                <i class="fas fa-book mr-3 text-lg"></i> {{ __('Student Course Block') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('student.evaluations.index') }}" :active="request()->routeIs('student.evaluations.index')">
                                <i class="fas fa-solid fa-clipboard-check mr-3 text-lg"></i> {{ __('Course Evaluation') }}
                            </x-nav-link>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('student.voting.index') }}" :active="request()->routeIs('student.voting.index')">
                                <i class="fas fa-vote-yea mr-3 text-lg"></i> {{ __('Cast Vote') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('student.voting.results') }}" :active="request()->routeIs('student.voting.results')">
                                <i class="fas fa-poll mr-3 text-lg"></i> {{ __('View Results') }}
                            </x-nav-link>
                        </div>
                    </div>
                @endif
                ...
                @if(Auth::user()->hasRole('teacher') || Auth::user()->hasRole('staff') || Auth::user()->hasRole('academic_head') || Auth::user()->hasRole('hr') || Auth::user()->hasRole('admin'))
                    <div class="mt-6 pt-3 border-t border-gray-700">
                        <h3 class="text-sm font-bold uppercase text-blue-400 px-3 py-1 bg-gray-800 rounded">Faculty/Staff Tools</h3>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('leave_applications.index') }}" :active="request()->routeIs('leave_applications.*')">
                                <i class="fas fa-solid fa-calendar-minus mr-3 text-lg"></i> {{ __('My Leave Applications') }}
                            </x-nav-link>
                            <x-nav-link href="#"><i class="fas fa-solid fa-money-check-dollar mr-3 text-lg"></i> {{ __('My Salary / Payslip') }}</x-nav-link>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('faculty.course-load') }}" :active="request()->routeIs('faculty.course-load')">
                                <i class="fas fa-solid fa-layer-group mr-3 text-lg"></i> {{ __('My Course Load') }}
                            </x-nav-link>
                            <x-nav-link href="#"><i class="fas fa-solid fa-clock mr-3 text-lg"></i> {{ __('My Class Schedule') }}</x-nav-link>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('faculty.course-blocks') }}" :active="request()->routeIs('faculty.course-blocks')">
                                <i class="fas fa-solid fa-file-import mr-3 text-lg"></i> {{ __('Grade Submission') }}
                            </x-nav-link>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('faculty.peer-evaluations.index') }}" :active="request()->routeIs('faculty.peer-evaluations.index')">
                                <i class="fas fa-solid fa-users-viewfinder mr-3 text-lg"></i> {{ __('Peer Evaluation') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('faculty.self-evaluations.index') }}" :active="request()->routeIs('faculty.self-evaluations.index')">
                                <i class="fas fa-solid fa-user-check mr-3 text-lg"></i> {{ __('Self Evaluation') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('supervisor.evaluations.index') }}" :active="request()->routeIs('supervisor.evaluations.index')">
                                <i class="fas fa-solid fa-user-tie mr-3 text-lg"></i> {{ __('Department Head Evaluation') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('teacher.evaluations.index') }}" :active="request()->routeIs('teacher.evaluations.index')">
                                <i class="fas fa-solid fa-chart-simple mr-3 text-lg"></i> {{ __('PES Result') }}
                            </x-nav-link>
                        </div>
                    </div>
                @endif

                {{-- ACADEMIC/REGISTRAR/HR/ADMIN TOOLS --}}
                @if(Auth::user()->hasRole('academic_head') || Auth::user()->hasRole('registrar') || Auth::user()->hasRole('hr') || Auth::user()->hasRole('admin'))
                    <div class="mt-6 pt-3 border-t border-gray-700">
                        <h3 class="text-sm font-bold uppercase text-blue-400 px-3 py-1 bg-gray-800 rounded">Enrollment & Reports</h3>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('admin.faculty.courses') }}" :active="request()->routeIs('admin.faculty.courses')">
                                <i class="fas fa-solid fa-magnifying-glass-chart mr-3 text-lg"></i> {{ __('Grade Submission Tracking') }}
                            </x-nav-link>
                            <x-nav-link :href="route('reports.index')" :active="request()->routeIs('reports.*')">
                                <i class="fas fa-solid fa-chart-line mr-3 text-lg"></i> {{ __('Standard Reports') }}
                            </x-nav-link>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('course_blocks.index') }}" :active="request()->routeIs('course_blocks.index')">
                                <i class="fas fa-solid fa-cubes mr-3 text-lg"></i> {{ __('Course Blocks') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('assign.courseblocks') }}" :active="request()->routeIs('assign.courseblocks')">
                                <i class="fas fa-solid fa-cubes mr-3 text-lg"></i> {{ __('Section Load Manager') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('course-blocks.bulk-uploader') }}" :active="request()->routeIs('course-blocks.bulk-uploader')">
                                <i class="fas fa-solid fa-cloud-arrow-up mr-3 text-lg"></i> {{ __('Course Blocks Bulk Uploader') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('coursetosections.index') }}" :active="request()->routeIs('coursetosections.*')">
                                <i class="fas fa-solid fa-diagram-project mr-3 text-lg"></i> {{ __('Course To Sections') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('assign.courses') }}" :active="request()->routeIs('assign.courses')">
                                <i class="fas fa-solid fa-people-arrows mr-3 text-lg"></i> {{ __('Students To Course Per Section') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('assign.individual') }}" :active="request()->routeIs('assign.individual')">
                                <i class="fas fa-solid fa-user-plus mr-3 text-lg"></i> {{ __('Students To Course (Individual)') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('students.index') }}" :active="request()->routeIs('students.index')">
                                <i class="fas fa-solid fa-users-gear mr-3 text-lg"></i> {{ __('Manage Students') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('courses.index') }}" :active="request()->routeIs('courses.*')">
                                <i class="fas fa-solid fa-book-journal-whills mr-3 text-lg"></i> {{ __('Manage Courses') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('enrollments.index') }}" :active="request()->routeIs('enrollments.*')">
                                <i class="fas fa-solid fa-file-signature mr-3 text-lg"></i> {{ __('Manage Enrollments') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('programs.index') }}" :active="request()->routeIs('programs.*')">
                                <i class="fas fa-solid fa-landmark mr-3 text-lg"></i> {{ __('Manage Programs') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('sections.index') }}" :active="request()->routeIs('sections.*')">
                                <i class="fas fa-solid fa-table-columns mr-3 text-lg"></i> {{ __('Manage Sections') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('academic_years.index') }}" :active="request()->routeIs('academic_years.*')">
                                <i class="fas fa-solid fa-calendar-check mr-3 text-lg"></i> {{ __('Manage Academic Years') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('semesters.index') }}" :active="request()->routeIs('semesters.*')">
                                <i class="fas fa-solid fa-timeline mr-3 text-lg"></i> {{ __('Manage Semesters') }}
                            </x-nav-link>
                        </div>
                    </div>
                @endif
                ...
                @if(Auth::user()->hasRole('teacher') || Auth::user()->hasRole('staff') || Auth::user()->hasRole('academic_head') || Auth::user()->hasRole('hr') || Auth::user()->hasRole('admin'))
                    <div class="mt-6 pt-3 border-t border-gray-700">
                        <h3 class="text-sm font-bold uppercase text-blue-400 px-3 py-1 bg-gray-800 rounded">OSA</h3>
                    </div>
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center justify-between w-full text-xs font-semibold uppercase text-gray-400 px-3 py-2 hover:bg-gray-700/50 rounded-md transition duration-150 focus:outline-none">
                ...
                @if(Auth::user()->hasRole('academic_head') || Auth::user()->hasRole('hr') || Auth::user()->hasRole('admin'))
                    <div class="mt-6 pt-3 border-t border-gray-700">
                        <h3 class="text-sm font-bold uppercase text-blue-400 px-3 py-1 bg-gray-800 rounded">HR & Administration</h3>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('employees.index') }}" :active="request()->routeIs('employees.*')">
                                <i class="fas fa-user-tie mr-3 text-lg"></i> {{ __('Manage Employees') }}
                            </x-nav-link>
                            ...
                            @if(Auth::user()->hasRole('academic_head'))
                                <x-nav-link href="{{ route('ah.leave_applications.index') }}" :active="request()->routeIs('ah.leave_applications.index')">
                                    <i class="fas fa-hourglass-half mr-3 text-lg"></i> {{ __('Pending Leave Applications') }}
                                </x-nav-link>
                            @elseif(Auth::user()->hasRole('hr'))
                                ...
                                <x-nav-link href="{{ route('hr.leave_applications.retroactive_form') }}" :active="request()->routeIs('hr.leave_applications.retroactive_form')">
                                    <i class="fas fa-file-upload mr-3 text-lg"></i> {{ __('Unfiled Leave Applications') }}
                                </x-nav-link>
                            ...
                            <x-nav-link href="{{ route('faculty-loadings.index') }}" :active="request()->routeIs('faculty-loadings.*')">
                                <i class="fas fa-chalkboard-teacher mr-3 text-lg"></i> {{ __('Faculty Loading') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('admin.leave.summary') }}" :active="request()->routeIs('admin.leave.summary')">
                                <i class="fas fa-calendar-check mr-3 text-lg"></i> {{ __('Leave Summary') }}
                            </x-nav-link>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('leave-credits.index') }}" :active="request()->routeIs('leave-credits.index')">
                                <i class="fas fa-calendar-plus mr-3 text-lg"></i> {{ __('Set Leave Credits') }}
                            </x-nav-link>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="mt-4 space-y-1" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-collapse.duration.300ms>
                            <x-nav-link href="{{ route('system-updates.manager') }}" :active="request()->routeIs('system-updates.*')">
                                <i class="fas fa-solid fa-wrench mr-3 text-lg"></i> {{ __('System Updates') }}
                            </x-nav-link>
                        </div>
                    </div>
                @endif
