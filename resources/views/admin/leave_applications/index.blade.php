<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Admin Leave Applications Review') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    @else
                        <p class="text-center text-gray-600">{{ __('No pending leave applications for Admin review.') }}</p>
                    @endif
                </div>
            </div>
        </div>
