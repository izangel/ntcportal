                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="program_type" id="program_type" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <option value="both" {{ old('program_type', $position->program_type) == 'both' ? 'selected' : '' }}>Both (SHS & College)</option>
                            <option value="shs" {{ old('program_type', $position->program_type) == 'shs' ? 'selected' : '' }}>SHS Only</option>
                            <option value="college" {{ old('program_type', $position->program_type) == 'college' ? 'selected' : '' }}>College Only</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $position->sort_order) }}" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
