<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="mb-6 flex items-start justify-between">
        ...
        <div class="flex flex-col sm:flex-row gap-2">
            ...
            <a href="{{ route('guides.teacher.assessment-tasks') }}"
               class="inline-flex items-center gap-2 px-4 py-2 bg-[#f8fafc] border border-gray-300 text-gray-700 rounded-lg text-sm font-bold hover:bg-gray-50">
                <i class="fas fa-list-check text-indigo-600"></i> Assessment Tasks by CLO Guide
            </a>
        </div>
    </div>
