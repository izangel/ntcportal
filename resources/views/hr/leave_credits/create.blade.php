    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Set Employee Leave Credits</h3>
                ...
                <form method="POST" action="{{ route('leave-credits.store') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-input id="sick_leave" class="block mt-1 w-full" type="number" name="sick_leave" :value="old('sick_leave')" required />
                        <x-input-error for="sick_leave" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-label for="vacation_leave" value="{{ __('Vacation Leave') }}" />
                        <x-input id="vacation_leave" class="block mt-1 w-full" type="number" name="vacation_leave" :value="old('vacation_leave')" required />
                        <x-input-error for="vacation_leave" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-label for="service_incentive_leave" value="{{ __('Service Incentive Leave') }}" />
                        <x-input id="service_incentive_leave" class="block mt-1 w-full" type="number" name="service_incentive_leave" :value="old('service_incentive_leave')" required />
