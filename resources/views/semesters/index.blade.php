    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Semesters List</h3>

                <div class="mb-4">
                    <a href="{{ route('semesters.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                        Add New Semester
                    </a>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($semesters as $semester)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $semester->id }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $semester->academicYear->start_year ?? 'N/A' }} - {{ $semester->academicYear->end_year ?? 'N/A' }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('semesters.edit', $semester) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">Edit</a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-gray-500">No semesters found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
