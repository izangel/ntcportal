        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600">Fill in the details below. You can select multiple categories if this date applies to more than one department.</p>
                </div>
                ...
                <form action="{{ route('important_dates.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" 
                               ...
                               placeholder="e.g. Midterm Examination Week" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="start_date" value="{{ old('start_date', $importantDate->start_date ?? '') }}" 
                                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">
                        </div>
                        <div>
                            <label class="block font-medium text-sm text-gray-700">End Date (Optional)</label>
                            <input type="date" name="end_date" value="{{ old('end_date', $importantDate->end_date ?? '') }}" 
                                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" 
                                  placeholder="Provide additional details about the event...">{{ old('description') }}</textarea>
