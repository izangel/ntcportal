        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <ul class="mt-3 space-y-2 text-sm text-gray-600">
                    ...
                    <li class="flex items-start gap-2"><i class="fas fa-angle-right text-indigo-400 mt-1"></i><span><strong class="text-gray-800">Grading System</strong> — computed automatically from your assessment tasks: each task's weight grouped by type. Keep task weights totaling 100% and this section stays correct.</span></li>
